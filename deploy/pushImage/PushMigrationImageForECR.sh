...
docker build -t $AWS_ACCOUNT_ID.dkr.ecr.$AWS_REGION.amazonaws.com/weatherreport_app:migration_v1.0 \
             -f $(git rev-parse --show-toplevel)/backend/Dockerfile.migration \
