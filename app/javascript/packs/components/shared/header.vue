<template>
  <div>
    <nav class="navbar fixed-top navbar-default navbar-toggleable-md bs-navbar navbar-dark">
      ...
      <ul class="nav navbar-nav nav-flex-icons ml-auto text-white">
        ...
        <li class="nav-item" v-if="logined">
          <div>
            {{ userName }}
            <router-link to="/logout" data-toggle="collapse" data-target=".navbar-collapse.show" class="text-white">ログアウト</router-link>
          </div>
        </li> 
      </ul>
      ...
      <div class="navbar-collapse collapse" id="navigationBar">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item"><router-link to="#" data-toggle="collapse" data-target=".navbar-collapse.show" class="text-white">雨雲の動き</router-link></li>
          <li class="nav-item"><router-link to="#" data-toggle="collapse" data-target=".navbar-collapse.show" class="text-white">地震情報</router-link></li>
        </ul>
      </div>
    </nav>
  </div>
