...
RSpec.describe "DailyForecasts", type: :request do
  describe "GET /api/daily_forecasts" do
    ...
    context 'パラメータに緯度、経度が与えられたとき' do
      ...
      let!(:forecast) { location.forecasts.create(forecast_datetime: DateTime.now, forecast_datetime: now_datetime, forecast_type: "daily")}
      ...
      let!(:weather_group) { forecast.weather_groups.create(weather_group_id: 1, weather_icon: "10d", weather_main: "Rain", weather_description: "heavy intensity rain") }
